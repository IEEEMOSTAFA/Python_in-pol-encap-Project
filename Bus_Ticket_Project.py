#  oop base : Bus Ticket Booking System:

#Admin -
# 1)Add a new buses
# 2)Check Abailable buses
...
class Bus:
    def __init__(self,coach,driver,arrival,departure,from_des,to):
        ...
        self.seat = ["Empty" for i in range(20)] #we use a list       

# b = Bus(2,"ahRim","12PM","12.30 PM","Dhaka","Chittagong")
# print(vars(b))         
    ...
    def reservation(self):
        ...
        for w in self.total_bus_lst:
            if bus_no == w['coach']:
                ...
                if seat_no > 20:  #we never access 20th number seat
